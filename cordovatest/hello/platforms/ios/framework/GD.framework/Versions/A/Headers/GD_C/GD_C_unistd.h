...
#   endif
    ...
    /** C API.
     */
    GD_C_API ssize_t GD_UNISTD_writev(int fd, const struct iovec* iov, int iovcnt);
    
    /** C API.
     */
    GD_C_API ssize_t GD_UNISTD_readv(int fd, const struct iovec* iov, int iovcnt);
    ...
    /** C API.
    */
    GD_C_API int GD_UNISTD_msync(void *addr, size_t length, int flags);
    ...
    /**< C API.
    */
    GD_C_API int GD_UNISTD_utimes(int fd, const struct utimbuf *times);
